...
window.SLM['theme-shared/biz-com/customer/biz/sign-up/subscribe.js'] = window.SLM['theme-shared/biz-com/customer/biz/sign-up/subscribe.js'] || function () {
  ...
  class Subscribe {
    constructor({
      ...
      this.checkedSubscriptionEmail = defaultCheck;
    }
...
window.SLM['theme-shared/biz-com/customer/biz/sign-up/index.js'] = window.SLM['theme-shared/biz-com/customer/biz/sign-up/index.js'] || function () {
  ...
  class Register extends Customer {
    ...
    init() {
      ...
      if (['username', 'email'].includes(mode)) {
        this.subscribe = new Subscribe({
          ...
          $$reports: this.$$reports,
          defaultCheck: SL_State.get('shop.store_register_config.marketingSubscription')
        });
      }
      this.bindEvents();
      new DatePicker({
    ...
    onSignUp({
      ...
      const registerAccount = (captchaToken, updateParams = {}, serialNo = '') => {
      ...
      return wrapArmorCaptcha({
        captchaScene: 'COldRegister',
        onCaptureCaptcha: registerAccount,
        onCaptchaVerifySuccess: (captchaToken, prevRequestResult, serialNo) => registerAccount(captchaToken, {
